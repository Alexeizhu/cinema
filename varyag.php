...
<div class="d-flex position-relative">
  <img class="img-size" src="imgs/var.jpg" class="flex-shrink-0 me-3" alt="...">
  <div class="mrn-left">
    <h4 class="mt-0"><strong>Варяг</strong></p>
...
<p class="h1">О фильме</p>
  <p class="textfont"><em>Принц Амлет мстит убийцам отца и хочет вернуть королевство, принадлежащее ему по праву.
</em></p>
</div>

...
<div class="d-flex position-relative">
  <img class="img-size" src="imgs/pp.jpg" class="flex-shrink-0 me-3" alt="...">
  <div class="mrn-left">
    <h4 class="mt-0"><strong>Плохие парни</strong></p>

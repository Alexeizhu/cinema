...
<div class="d-flex position-relative">
  <img class="img-size" src="imgs/thor.jpg" class="flex-shrink-0 me-3" alt="...">
  <div class="mrn-left">
    <h4 class="mt-0"><strong>Тор. Любовь и гром</strong></p>
    <p class="textfont"><small>Жанр: фэнтези, боевик, приключения</small></p>
    <a href="" class="btn btn-primary disabled">Скоро в кино</a>
  </div>
</div>
<p class="h1">О фильме</p>
  <p class="textfont"><em>Джейн Фостер берет на себя обязанности Бога-громовержца и становится обладательницей молота Мьёльнира.</em></p>
</div>
